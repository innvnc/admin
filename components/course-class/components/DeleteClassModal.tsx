...
export const DeleteClassModal = ( { isOpen, isPending, classTitle, onCancel, onConfirm }: Props ) => (
  <UI.Modal isOpen={ isOpen } onOpenChange={ onCancel }>
    <UI.ModalContent>
      ...
      <UI.ModalBody>
        <p>
          ¿Estás seguro que deseas eliminar la clase <strong>{ classTitle }</strong>? Esta acción no se puede deshacer.
        </p>
      </UI.ModalBody>
