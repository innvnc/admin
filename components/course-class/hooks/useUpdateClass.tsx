...
export const useUpdateClass = () => {
  ...
  const mutation = useMutation( {
    mutationFn: ( { id, data }: { id: string; data: ClassInputs; } ) => updateClass( id, data ),
    onSuccess: ( data ) => {
  ...
  const updateCourseClass = async ( id: string, data: ClassInputs ): Promise<IClassCourseResponse> => {
