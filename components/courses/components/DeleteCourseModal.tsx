...
export const DeleteCourseModal = ( { isOpen, isPending, courseTitle, onCancel, onConfirm }: Props ) => (
  <UI.Modal isOpen={ isOpen } onOpenChange={ onCancel }>
    <UI.ModalContent>
      ...
      <UI.ModalBody>
        <p>
          ¿Estás seguro que deseas eliminar el curso <strong>{ courseTitle }</strong>? Esta acción no se puede deshacer.
        </p>
      </UI.ModalBody>
