...
import { CreateSectionInputs, UpdateSectionInputs } from '../validators/CourseSectionSchema';
...
export const useCourseSectionFormHelper = (
    ...
    const { courseSections = [] } = useGetCourseSectionsByCourseId(form.getValues().courseId || '');
