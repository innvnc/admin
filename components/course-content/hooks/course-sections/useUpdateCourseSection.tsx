...
export const useUpdateCourseSection = () => {
  ...
  const mutation = useMutation( {
    mutationFn: ( { id, data }: { id: string; data: UpdateSectionInputs; } ) => updateCourseSection( id, data ),
    onSuccess: ( data ) => {
  ...
  const updateSection = async ( id: string, data: UpdateSectionInputs ): Promise<ICourseSection> => {
